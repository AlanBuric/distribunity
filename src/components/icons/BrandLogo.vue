...
<template>
  <svg width="100px" viewBox="0 0 81.172 81.172" alt="Distribunity logo, white letter D inside aquamarine square"
    xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <radialGradient id="b" xlink:href="#a" cx="-105.352" cy="-53.014" fx="-105.352" fy="-53.014" r="132.164"
