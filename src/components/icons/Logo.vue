...
<template>
    <svg width="100px" viewBox="0 0 81.172 81.172" alt="Distribunity logo, white letter D inside aquamarine square" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <defs>
            ...
            <filter style="color-interpolation-filters:sRGB" id="c" x="-.091" y="-.075" width="1.183" height="1.151">
        ...
        <path
            style="fill:url(#b);stroke:#00f1cd;stroke-width:21.6497;stroke-linecap:butt;stroke-linejoin:round;stroke-dasharray:none;paint-order:stroke markers fill"
        ...
        <g transform="translate(-54.138 -71.896) scale(.83494)" style="filter:url(#c)">
            <path
                style="fill:#fff;fill-opacity:1;stroke:none;stroke-width:6.82001;stroke-linecap:butt;stroke-linejoin:round;stroke-dasharray:none;paint-order:stroke markers fill"
